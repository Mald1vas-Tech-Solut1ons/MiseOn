          ...
          <div className="space-y-3 mb-10">
            ...
            <Expansivel titulo="Por que não consigo confirmar/finalizar um pedido?">
              ...
              <ul className="list-disc space-y-2 pl-5 mt-2">
                ...
                <li><b>{tDynamic('Pedido de entrega:')}</b> precisa sair para rota (tela <Link to="/admin/entregas" className="font-semibold text-[var(--cor-primaria)] hover:underline">Entregas</Link>) antes de finalizar.</li>
              </ul>
            ...
            <Expansivel titulo="Como funciona a integração com o iFood">
              <p>{tDynamic('Depois de vinculada em')} <Link to="/admin/ifood" className="font-semibold text-[var(--cor-primaria)] hover:underline">{tDynamic('Integração iFood')}</Link>, o processo é mágico:</p>
              <ol className="list-decimal space-y-1.5 pl-5 mt-2">
                <li>{tDynamic('O cliente pede no app do iFood e o pedido')} <b>cai sozinho</b> no seu Painel de Pedidos, com selo vermelho "iFood";</li>
                <li>{tDynamic('Você confirma e produz normalmente — o fluxo é o mesmo dos outros pedidos;')}</li>
                <li>{tDynamic('No Financeiro, a')} <b>taxa do iFood já vem descontada</b>: você vê o bruto, a taxa retida e o líquido real.</li>
              </ol>
              <div className="mt-3 border-l-2 border-red-500 pl-3">
                ...
                <p className="text-sm mt-1">
                  {tDynamic('Cada produto seu precisa do')} <b>{tDynamic('Código iFood (PDV)')}</b> preenchido — o mesmo código que está no
             ...
             <div className="relative flex items-start gap-4">
               ...
               <div>
                  ...
                  <p className="text-sm leading-relaxed text-emerald-100/85">
                    {tDynamic('A IA do MiseOn responde seus clientes no WhatsApp usando os dados')} <b className="text-white">reais</b> da sua loja — cardápio, preços, estoque e horário.
          ...
          <div className="space-y-3 mb-10">
            <Expansivel titulo="O que a IA faz (e o que ela NUNCA faz)" aberto_inicial>
              ...
              <ul className="list-disc space-y-1.5 pl-5 mt-2">
                ...
                <li><b>{tDynamic('Nunca inventa preço nem desconto:')}</b> valores só aparecem se existirem no sistema. Isso protege você de ter que honrar uma "promoção" que não existe;</li>
                ...
                <li><b>{tDynamic('Áudio e imagem:')}</b> por enquanto ela avisa que não entende e te chama para assumir.</li>
              </ul>
            </Expansivel>
            <Expansivel titulo="Você continua no controle da conversa">
              <p>{tDynamic('Todas as conversas — WhatsApp e chat do site — chegam na mesma caixa de entrada, em')} <b>Conversas</b>:</p>
              <ul className="list-disc space-y-1.5 pl-5 mt-2">
                ...
                <li><b>{tDynamic('Botão de emergência:')}</b> desligar a IA não desliga o recebimento — as mensagens continuam chegando para você atender manualmente.</li>
              </ul>
            </Expansivel>
            <Expansivel titulo="O que você precisa para conectar">
              <p><b>{tDynamic('Opção A — disponível hoje: número dedicado.')}</b> Você usa um chip novo só para o atendimento automático (qualquer pré-pago serve). O assistente de conexão te guia em 4 passos, com imagem de cada tela, e valida tudo sozinho.</p>
            ...
            <Expansivel titulo="Quanto custa">
              <ul className="list-disc space-y-1.5 pl-5">
                ...
                <li><b>{tDynamic('Fora da janela de 24h')}</b> (ex.: avisar um cliente do dia anterior) só é possível com mensagens-modelo pagas — <b>desligadas por padrão</b>. Se um dia você quiser ligar, o custo estimado aparece na tela antes de confirmar;</li>
            ...
            <Expansivel titulo="Como acompanhar se está funcionando">
              <ul className="list-disc space-y-1.5 pl-5">
                <li><b>{tDynamic('Saúde da conexão:')}</b> a tela de integração mostra o semáforo (conectado/pendente/erro) e o motivo em português claro se algo falhar;</li>
                ...
                <li><b>{tDynamic('Resultado no Dashboard:')}</b> conversas atendidas, % resolvidas sem você intervir e pedidos gerados — a prova do retorno.</li>
              </ul>
            </Expansivel>
          </div>
          ...
          <div className="space-y-3 mb-10">
            <Expansivel titulo="iFood">
              <p>
                ...
                Configure em <Link to="/admin/ifood" className="font-semibold text-[var(--cor-primaria)] hover:underline">{tDynamic('Integração iFood')}</Link>.
              </p>
            </Expansivel>
          </div>
        </div>
          ...
          <div className="space-y-4 mb-10">
            ...
            <Passo n={2} titulo="Copie o Identificador de conta">
              ...
              <ol className="list-decimal space-y-1 pl-5 mt-2">
                ...
                <li>{tDynamic('No menu lateral, clique em')} <b>API</b> → <b>{tDynamic('Identificador de conta')}</b> (topo direito);</li>
            ...
            <Passo n={3} titulo="Informe CPF/CNPJ e Conta para o Pix">
              ...
              <ul className="list-disc space-y-1 pl-5 mt-2">
                ...
                <li><b>{tDynamic('Número da conta Efí')}</b> (veja no app em Perfil → Dados da conta).</li>
              </ul>
            </Passo>
          </div>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="space-y-3 mb-10">
            ...
            <Expansivel titulo="Taxa de Cancelamento e Rejeição">
              <p>A <b>{tDynamic('Taxa de Cancelamento')}</b> mostra quantos pedidos não foram concluídos. Se estiver acima de 5%, é um sinal de alerta.</p>
            ...
            <Expansivel titulo="Horários de Pico (Mapa de Calor)">
              ...
              <p className="mt-2 text-sm">
                <b>Dica de Ouro:</b> {tDynamic('Se terça-feira às 19h é o seu horário mais fraco, crie uma')} <i>{tDynamic('Promoção Relâmpago')}</i> específica para esse dia para atrair demanda. Se sexta às 21h é o pico, reforce a equipe da cozinha e entregadores.
              </p>
            </Expansivel>
            <Expansivel titulo="Produtos Mais Vendidos vs. Mais Lucrativos">
              ...
              <p className="mt-2 text-sm">
                {tDynamic('Sempre coloque os produtos')} <b>mais lucrativos</b> em destaque no seu cardápio digital, e não apenas os que saem mais.
              </p>
            </Expansivel>
          </div>
        </div>

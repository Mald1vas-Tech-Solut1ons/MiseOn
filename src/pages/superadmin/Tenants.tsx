            ...
            return (
              <div key={l.id} className={`flex flex-col gap-4 rounded-2xl border border-white/10 bg-white/5 p-5 transition-all hover:bg-white/10 ${!l.ativo ? 'opacity-50 grayscale' : ''}`}>
                <div className="flex items-center justify-between">
                  ...
                  <button type="button" onClick={() => toggleAtivo(l)}
                ...
                <div className="mt-4 flex gap-2">
                  <button type="button" onClick={() => { setLojaEditando(l); setEditForm({ nome: l.nome, slug: l.slug }); }} className="flex-1 rounded-lg bg-white/5 py-2 text-xs font-semibold text-white transition-colors hover:bg-white/10 border border-white/10">
                    Editar Configs
                  </button>
                  <button type="button" onClick={() => setLojaFaturas(l)} className="flex-1 rounded-lg bg-indigo-500/10 py-2 text-xs font-semibold text-indigo-400 transition-colors hover:bg-indigo-500/20 border border-indigo-500/20">
                    Ver Faturas
                  </button>
                  <button type="button" onClick={() => setLojaPerfil(l)} className="flex-1 rounded-lg bg-amber-500/10 py-2 text-xs font-semibold text-amber-400 transition-colors hover:bg-amber-500/20 border border-amber-500/20">
                    {tDynamic('Perfil do Negócio')}
                  </button>
                  <button type="button" onClick={() => setLojaSuporte(l)} className="flex-1 rounded-lg bg-green-500/10 py-2 text-xs font-semibold text-green-400 transition-colors hover:bg-green-500/20 border border-green-500/20">
                    Atender Loja
                  </button>
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="w-full max-w-lg rounded-3xl border border-white/10 bg-gray-900 p-6 shadow-2xl">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button type="button" onClick={() => setLojaFaturas(null)} className="text-gray-400 hover:text-white">&times;</button>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="w-full max-w-lg rounded-3xl border border-white/10 bg-gray-900 p-6 shadow-2xl">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button type="button" onClick={() => setLojaPerfil(null)} className="text-gray-400 hover:text-white">&times;</button>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-3xl border border-white/10 bg-gray-900 overflow-hidden shadow-2xl flex flex-col h-[600px]">
            <div className="bg-white/5 p-4 border-b border-white/10 flex justify-between items-center">
              ...
              <button type="button" onClick={() => setLojaSuporte(null)} className="text-gray-400 hover:text-white">&times;</button>
            </div>

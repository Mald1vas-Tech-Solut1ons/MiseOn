...
export const LANDING_PAGES_DATA: Record<string, LandingPageData> = {
  ...
  'sistema-para-restaurante-por-quilo': {
    ...
    h1Title: 'O sistema para restaurante por quilo com',
    h1Highlight: 'baixa automática de estoque por peso real',
    subheadline: 'Veja o custo de cada grama que sai da travessa. Calcule pratos por peso (R$/kg) ou por unidade a partir da sua ficha técnica, com o rendimento que a sua cozinha mediu — e cada grama servida baixa o estoque na proporção da receita.',
    heroMetrics: [
      { label: 'Perda de cocção dentro do custo', value: 'Rendimento real' },
      { label: 'Baixa proporcional ao peso servido', value: 'Por grama' },

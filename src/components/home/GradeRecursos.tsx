...
const GRADE = [
  ...
  { icon: <TrendingUp size={20} />, titulo: 'Financeiro organizado', texto: 'Extrato de vendas e uma prévia visual da DRE. A integração completa dos dados contábeis ainda está em evolução.' },

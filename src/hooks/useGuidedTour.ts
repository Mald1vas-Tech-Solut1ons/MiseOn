...
export const TOUR_STEPS: TourStep[] = [
  // ── Módulo 1: Painel de Pedidos & Bastão Balcão ──
  {
    ...
    titulo: '1. Central de Comando dos Pedidos',
    tituloEn: '1. Orders Command Center',
  ...
  },
  {
    ...
    titulo: '2. Regra do Bastão & Baixa de Estoque',
    tituloEn: '2. Handoff Rule & Inventory Deduction',
  ...
  },
  {
    ...
    titulo: '6. Regra de Conversão & Fracionamento',
    tituloEn: '6. Yield & Conversion Rule',
  ...
  },
  {
    ...
    descricao: 'Em Produção → "Fichas & manipulações", você monta o que entra e o que sai de cada lote (ex: 1 kg de tomate entra, e o rendimento real sai em fatias). O MiseOn conserva o custo PEPS da matéria-prima no item produzido e calcula o CMV e a margem real.',
    descricaoEn: 'Under Production → "Production sheets & processing", you define what goes into and comes out of each batch (e.g. 1 kg of tomatoes in, actual yield out in slices). MiseOn carries the FIFO cost of the raw material into the finished item and calculates COGS and your real margin.',
    ...
    rota: '/admin/producao',
    targetDataTour: 'tour-producao-aba-fichas',
    posicao: 'bottom',
    clicarElementoTarget: true,
  },
  ...
  },
  {
    ...
    descricao: 'Como ler a cena 3D: o tamanho da esfera representa o volume físico em estoque (kg/L/unidades); a cor representa o custo unitário, do econômico à alta densidade financeira; os dutos conectam a compra original ao fracionamento.',
    descricaoEn: 'How to read the 3D scene: sphere size represents physical stock volume (kg/L/units); color represents unit cost, from low to high financial density; pipes connect the original purchase to fractioning.',
  ...
  },
  {
    ...
    titulo: '12. Cartões de Rastreio por Setor (Freezer/Dispensa)',
    tituloEn: '12. Sector Tracking Cards (Freezer/Pantry)',
    descricao: 'Na aba "Rastreio 3D", você acompanha os itens por setor da cozinha: geladeira, armário e despensa. Os cartões exibem a esteira de perdas, lotes PEPS ativos e alertas de rendimento declarado pela equipe.',
    descricaoEn: 'In the "3D Tracking" tab, you monitor items by kitchen sector: fridge, cupboard and pantry. Cards show the loss pipeline, active FIFO batches and team-declared yield alerts.',
  ...
  // ── Módulo 4: Salão 3D & Atendimento de Mesas ──
  {
    ...
    titulo: '13. Planta Baixa do Salão 3D & Atendimento',
    tituloEn: '13. 3D Floor Plan & Table Service',
